...
Nous utiliserons dans cette séance les [statistiques des bibliothèques de Grenoble](https://data.metropolegrenoble.fr/visualisation/information/?id=statistiques-des-bibliotheques-de-grenoble).
...
Nous allons maintenant créer un tableau de bord assez simple permettant de visualiser les [statistiques des bibliothèques de Grenoble](https://data.metropolegrenoble.fr/visualisation/information/?id=statistiques-des-bibliotheques-de-grenoble).
...
La correction de l'exercice est disponible à l'URL suivante : [./data/TP8-correction.zip](./data/TP8-correction.zip)
:::
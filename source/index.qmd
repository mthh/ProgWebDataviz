...
| 03/11/2025 | 10h-13h | TP - Visualisation de données géospatiales avec Leaflet                                                  | [Support](./TP-seance7.html) |
| 03/11/2025 | 14h-17h | CM / TP - Vues synchronisées, dashboards, etc. (Plot / Leaflet / D3.js)                                  | [Support](./TP-seance8.html) |
| 04/11/2025 | 10h-13h | TP - Vues synchronisées, dashboards, etc. (Plot / Leaflet / D3.js), suite                                | Voir lien précédent |
| 04/11/2025 | 14h-17h | TP - Visualisation dans un document Quarto (R / Python / JavaScript)                                     | [Support](./TP-seance10.html) |
...
- [une note de projet](https://observablehq.com/@sd-progwebdataviz/tp-note-atp-tour) (50%) - ce projet sera réalisé seul ou en binôme (à rendre pour le 10/12/2025 à 20h00),
- un TP noté (50%) - ce TP individuel sera réalisé en salle le 10/12/2025.

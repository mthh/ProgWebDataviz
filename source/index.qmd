...
|---------------|---------|-----------------------------------------------------------------------------------------------------------|-----------------------------|
| 11/09/2023    | 10h-13h | CM - Cours d'introduction + TP sur Observable                                                             | [Slides](./CM-seance1.html) |
| 11/09/2023    | 14h-17h | TPs - Rappels JavaScript et manipulation de données + Bibliothèque Plot                                   | Voir URL des TP plus bas    |
| 12/09/2023    | 09h-12h | CM - Règles et conseils pour la conception de visualisation de données + TP - Datavisualisation avec Plot | Slides                      |
| 12/09/2023    | 13h-16h | TP - Datavisualisation avec Plot                                                                          | Voir URL des TP plus bas    |
| 13/09/2023    | 09h-12h | TP - Leaflet                                                                                              | Voir URL des TP plus bas    |
| 13/09/2023    | 13h-16h | CM/TP D3.js                                                                                               | Voir URL des TP plus bas    |
...
- TP - Prix des carburants
- TP - Sea ice extent
- Bibliothèque Plot (partie 2) - Interactions
- TP - Leaflet
